    ...
    <div className="hero min-h-screen bg-base-200">
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="text-center lg:text-left">
          ...
          <p className="py-6">
            Welcome Back to Blooner! Log in to your account to continue making a
            difference in the lives of those in need. Your commitment to blood
            donation is invaluable, and we appreciate your dedication. need.
          </p>
        </div>
